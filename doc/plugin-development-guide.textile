...
bc.. <project>
  ...
  <parent>                                        # Relates to the parent POM.
    ...
    <version>0.4-SNAPSHOT</version>               # newer version of DeepaMehta is available.
  </parent>
  ...
  <dependencies>                                  # Most DeepaMehta 3 plugin projects
    <dependency>                                  # depend on the DeepaMehta 3 Core module.
      ...
      <version>0.4-SNAPSHOT</version>             # newer version of DeepaMehta is available.
    </dependency>                                 # If your plugin contains no Java code at
  </dependencies>                                 # all, the dependencies element is not needed.
