...
h1. Set up the development environment
...
3. Create a directory where your DeepaMehta development takes place and go there, e.g.:
...
The structure within your plugin project directory is determined by a mix of both, Maven conventions and DeepaMehta conventions.
