...
@Provider
public class PermissionsProvider implements MessageBodyReader {
    ...
    @Override
    public Permissions readFrom(Class type, Type genericType, Annotation[] annotations, MediaType mediaType,
