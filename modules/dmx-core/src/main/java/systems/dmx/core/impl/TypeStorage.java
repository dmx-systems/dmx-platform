...
class TypeStorage {
    ...
    private TopicTypeModelImpl fetchTopicType(String topicTypeUri) {
        try {
            ...
            //
            // fetch generic topic
            TopicModelImpl typeTopic = al.sd.fetchTopic("uri", topicTypeUri);
    ...
    private AssocTypeModelImpl fetchAssocType(String assocTypeUri) {
        try {
            ...
            //
            // fetch generic topic
            TopicModelImpl typeTopic = al.sd.fetchTopic("uri", assocTypeUri);
    ...
    private RelatedTopicModel defaultCardinality(AssocModelImpl assoc) {
        ...
        if (cardinality != null) {
            ...
            return mf.newRelatedTopicModel(al.sd.fetchTopic("uri", ONE));    // ### FIXME
        }
    }
