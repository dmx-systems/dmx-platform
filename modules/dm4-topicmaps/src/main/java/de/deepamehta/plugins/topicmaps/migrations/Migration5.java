...
public class Migration5 extends Migration {
    ...
    @Override
    public void run() {
        dms.createTopicType(new TopicTypeModel("dm4.topicmaps.private", "Private", "dm4.core.boolean"));
        dms.getTopicType("dm4.topicmaps.topicmap").addAssocDef(new AssociationDefinitionModel(
