...
public class CompositeTest {
    ...
    public void composite() {
        CompositeValueModel person = new CompositeValueModel()
            .put("dm4.core.name", "Karl Blum")
            .put("dm4.contacts.home_address", new CompositeValueModel()
                .put("dm4.contacts.postal_code", 13206)
                .put("dm4.contacts.city", "Berlin"))
            .put("dm4.contacts.office_address", new CompositeValueModel()
